...
@section('content')
    <div class="overflow-x-auto w-[100%%] ml-6">
                    ...
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <td class="px-6 py-4 ">
                            <button class="h-[100%] w-[100%]">
                                @if ($dataUser->member == 1)
                                    <i class="fa-solid fa-circle-check text-2xl text-green-500"></i>
                                @else
                                    <i class="fa-solid fa-square-xmark text-red-500 text-2xl"></i>
                                @endif
